...
CREATE SEQUENCE repayment_id_seq START WITH 1 INCREMENT BY 1;
...
CREATE TABLE ACCOUNT (
    ...
    OPEN_DATE DATE,
    ACCOUNT_TYPE VARCHAR2(50) CHECK (ACCOUNT_TYPE IN ('Savings', 'Current')),
    STATUS VARCHAR2(20),
...
/*CREATE TABLE SAVINGS_ACCOUNT (
    ...
    WITHDRAWAL_LIMIT NUMBER(10,2) NOT NULL CHECK (WITHDRAWAL_LIMIT >= 0),
    SAVINGS_ACC_TYPE VARCHAR2(50) NOT NULL,
...
CREATE TABLE SAVINGS_ACCOUNT (
    ...
    FLAG VARCHAR(15) DEFAULT 'SAVINGS'
);
